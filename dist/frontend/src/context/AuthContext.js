...
var AuthProvider = function (_a) {
    ...
    var _c = (0, react_1.useState)(true), loading = _c[0], setLoading = _c[1]; // Initially true to check for stored user
    (0, react_1.useEffect)(function () {
        // On component mount, try to load user from local storage
        try {
            var storedUser = localStorage.getItem('aiyamiddun_user');
            if (storedUser) {
    ...
    var login = function (username, password) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, , 3, 4]);
                    return [4 /*yield*/, (0, api_1.apiLogin)(username, password)];
                case 2:
                    userData = _a.sent();
                    setUser(userData);
    ...
    var register = function (userData) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, , 3, 4]);
                    return [4 /*yield*/, (0, api_1.apiRegister)(userData)];
                case 2:
                    newUser = _a.sent();
                    setUser(newUser);
