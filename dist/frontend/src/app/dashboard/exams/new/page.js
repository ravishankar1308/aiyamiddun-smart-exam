...
function NewExamPage() {
    ...
    var _b = (0, react_1.useState)({
        ...
        subject_id: '',
        duration_minutes: 60,
    }), examDetails = _b[0], setExamDetails = _b[1];
    var _c = (0, react_1.useState)([]), availableQuestions = _c[0], setAvailableQuestions = _c[1];
    var _d = (0, react_1.useState)([]), selectedQuestions = _d[0], setSelectedQuestions = _d[1];
    var _e = (0, react_1.useState)({ subjects: [] }), metadata = _e[0], setMetadata = _e[1];
    var _f = (0, react_1.useState)(true), loading = _f[0], setLoading = _f[1];
    var _g = (0, react_1.useState)(null), error = _g[0], setError = _g[1];
    var router = (0, navigation_1.useRouter)();
    (0, react_1.useEffect)(function () {
        var fetchInitialData = function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, meta, questions, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, 3, 4]);
                        setLoading(true);
                        return [4 /*yield*/, Promise.all([(0, api_1.apiGetMetadata)(), (0, api_1.apiGetQuestions)()])];
                    case 1:
                        _a = _b.sent(), meta = _a[0], questions = _a[1];
                        setMetadata(meta);
                        setAvailableQuestions(questions);
                        return [3 /*break*/, 4];
                    case 2:
                        err_1 = _b.sent();
                        setError(err_1.message || 'Failed to load initial data.');
                        return [3 /*break*/, 4];
                    case 3:
                        setLoading(false);
                        return [7 /*endfinally*/];
    ...
    var handleCreateExam = function () { return __awaiter(_this, void 0, void 0, function () {
        var examData, err_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, api_1.apiCreateExam)(examData)];
                case 2:
                    _a.sent();
                ...
                case 3:
                    err_2 = _a.sent();
                    setError(err_2.message || 'Failed to create exam.');
                    return [3 /*break*/, 5];
                case 4:
                    setLoading(false);
                    return [7 /*endfinally*/];
    ...
    return (<div className="bg-white p-8 rounded-lg shadow-md max-w-4xl mx-auto">
            ...
            <div className="mb-8 flex justify-center">
                <div className="flex items-center">
                    ...
                    <p className={"ml-2 ".concat(step >= 2 ? 'font-semibold' : '')}>Add Questions</p>
                </div>
            </div>
                    ...
                    <div className="h-96 overflow-y-auto border rounded-lg p-4 space-y-3">
                     ...
                     <div className="flex justify-between items-center mt-8">
                        ...
                        <button onClick={handleCreateExam} disabled={loading} className="bg-green-500 text-white py-2 px-6 rounded-lg flex items-center gap-2 hover:bg-green-600 disabled:bg-gray-400">
                           {loading ? 'Saving...' : 'Create Exam'} <lucide_react_1.Save size={20}/>
                        </button>
                    </div>
                </div>)}
        </div>);
}
exports.default = NewExamPage;
