...
export const updateQuestion = async (req: Request, res: Response) => {
    const { id } = req.params;
    try {
        await questionService.updateQuestion(id, req.body);
...
export const updateQuestionStatus = async (req: Request, res: Response) => {
    ...
    try {
        const message = await questionService.updateQuestionStatus(id, status);
        res.json({ message });
    } catch (error) {
...
export const toggleQuestionDisable = async (req: Request, res: Response) => {
    const { id } = req.params;
    try {
        const message = await questionService.toggleQuestionDisable(id);
        res.json({ message });
    } catch (error) {
