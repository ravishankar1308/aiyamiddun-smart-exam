...
var generateQuestion = function (prompt) { return __awaiter(void 0, void 0, void 0, function () {
    var model, result, response, text, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [2 /*return*/, { generatedText: text }];
            case 4:
                error_1 = _a.sent();
                console.error('API call to Gemini failed:', error_1);
