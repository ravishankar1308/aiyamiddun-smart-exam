...
var exam_routes_1 = __importDefault(require("./routes/exam.routes"));
var ai_routes_1 = __importDefault(require("./routes/ai.routes"));
var metadata_routes_1 = __importDefault(require("./routes/metadata.routes"));
dotenv_1.default.config();
var app = (0, express_1.default)();
var port = process.env.PORT || 3001; // Changed to 3001 to avoid potential conflicts
// --- Database Connection ---
var dbConfig = {
